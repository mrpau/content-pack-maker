...
ar: pex
	PEX_MODULE=contentpacks ./makecontentpacks ka-lite ar 0.17 --out=out/langpacks/ar.zip --no-assessment-resources
...
id: pex
	PEX_MODULE=contentpacks ./makecontentpacks ka-lite id 0.17 --out=out/langpacks/id.zip --no-assessment-resources

hi: pex
	PEX_MODULE=contentpacks ./makecontentpacks ka-lite hi 0.17 --out=out/langpacks/hi.zip --no-assessment-resources
...
xh: pex
	PEX_MODULE=contentpacks ./makecontentpacks ka-lite xh 0.17 --out=out/langpacks/xh.zip --no-assessment-resources
